...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Vous2.css"/>
    ...
    <body>
        ...
        <ul>
            ...
            <li style="float:right"><a class="active" href="Vous2.php"><img src="Images/profile.png" alt="Profil" title="Profil"/></a></li>
            ...
            <li style="float:right"><a href="Accueil2.php"><img src="Images/home.png" alt="Acceuil" title="Acceuil"/></a></li>
         ...
         <div class="row">
            ...
            <div class="infos">
                ...
                <h3>Date de naissance:</h3> <?php echo $donnees['date_de_naissance']; ?>
                <h3>Matière enseignée:</h3> <?php echo $donnees['matiere']; ?>
...
?>
            ...
            <div class="cv">
                ...
                <h2>Ajouter une offre d'enploi</h2>
                <center><a href="propositionemploi.php" class="modifier">Ajouter</a></center>
            ...
            <div class="plus">
                ...
                <center><a href="ModifMDP2.php" class="modifier">Modifier</a></center>
