        ...
        <!--barre de navigation-->
         <div class="navbar">
            <ul>
                ...
                <li style="float:right"><a class="active" href="Emplois2.php"><img src="Images/employment.png" alt="Emplois" title="Emplois"/></a></li>
         ...
         <div class="row">
            ...
            <div class="side">
				...
				<form action="Emplois2.php" method="post">		
